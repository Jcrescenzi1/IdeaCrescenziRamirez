...
-- DCL:
-- Los usuarios creados no pueden eliminar o ejecutar las funciones y stored procedures definidos por el usuario root.
...
START transaction;
delete from arbitro where id_arbitro=13; -- Se elimina un registro de prueba generado en las funciones, ver que queda otro mas con id_arbitro = 14
Select * from arbitro;
-- ROLLBACK;
COMMIT;

START TRANSACTION;
INSERT INTO estadios VALUES (null,'Saint-Denis','Stade de France bis',80000);
INSERT INTO estadios VALUES (null,'Marsella','Stade Velodrome bis',67000);
INSERT INTO estadios VALUES (null,'Saint-Etienne','Stade Geoffroy Guichard bis',42000);
INSERT INTO estadios VALUES (null,'Nantes','Stade de la Beaujoire bis',35000);
savepoint estadiosbis1;
INSERT INTO estadios VALUES (null,'Bordeaux','Stade de Bordeaux bis',42000);
INSERT INTO estadios VALUES (null,'Lille','Stade Pierre Mauroy bis',50000);
INSERT INTO estadios VALUES (null,'Lyon','OL bis',58883);
INSERT INTO estadios VALUES (null,'Niza','Stade de Nice bis',35000);
savepoint estadiosbis2;
select * from estadios;
-- RELEASE SAVEPOINT estadiosbis1;
ROLLBACK;
-- COMMIT;
